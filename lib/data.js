...
export const COMPANY = {
  ...
  description:
    'PyTech Digital is a full-stack IT, digital solutions and growth firm headquartered in Noida, scaling across Gurugram and global markets. We build software, craft brands, drive AI-first marketing and automate revenue workflows.',
  hq: 'Noida, India',
  email: 'hello@pytechdigital.com',
  phone: '+91 98100 12345',
  whatsapp: '919810012345', // digits only for wa.me link
  url: 'https://pytechdigital.com',
  founded: '2019',
  sameAs: [
    'https://www.linkedin.com/company/pytechdigital',
    'https://twitter.com/pytechdigital',
    'https://www.instagram.com/pytechdigital',
  ],
};
